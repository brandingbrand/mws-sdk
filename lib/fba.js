      ...
      if (packageList && packageList.length > 0) {
          ...
          packageList.forEach(package => {
              const dimensionObj = {
                  ...
                  'Dimensions.Unit': package.dimensions.unit,
                  'Weight.Value': package.weight.value,
                  'Weight.Unit': package.weight.unit,
              };

              packageListObj.members.push(dimensionObj);
      ...
      if (palletList && palletList.length > 0) {
          ...
          palletList.forEach(pallet => {
              const dimensionObj = {
                  ...
                  'Dimensions.Width': pallet.dimensions.width,
                  'Dimensions.Height': pallet.dimensions.height,
                  'Dimensions.Unit': pallet.dimensions.unit,
                  'Weight.Value': pallet.weight.value,
                  'Weight.Unit': pallet.weight.unit,
                  'IsStacked': pallet.isStacked
              };

              palletListObj.members.push(dimensionObj);
